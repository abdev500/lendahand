...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        image_categories = {
            'Support for Belarusian Families': ['humanitarian_1.jpg', 'humanitarian_2.jpg', 'humanitarian_3.jpg', 'humanitarian_4.jpg', 'support_1.jpg', 'support_2.jpg'],
        ...
        for idx, campaign_data in enumerate(campaigns_data):
            ...
            image_list = image_categories.get(campaign_title, ['humanitarian_1.jpg', 'humanitarian_2.jpg', 'humanitarian_3.jpg', 'support_1.jpg'])
            ...
            if created or existing_media_count < 3:
                ...
                for idx, image_filename in enumerate(selected_images):
                    ...
                    if image_path.exists():
                        ...
                        self.stdout.write(
                            self.style.WARNING(f'Image not found: {image_filename}, using placeholder')
                        )
        ...
        for news_data in news_entries:
            news, created = News.objects.get_or_create(
                translations__title=news_data['title_en'],
            ...
            if created:
                ...
                self.stdout.write(
                    self.style.SUCCESS(f'Created news: {news_data["title_en"]}')
                )
